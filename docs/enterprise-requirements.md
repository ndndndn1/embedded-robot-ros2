...
| F-02 | Support MH-01 and MM-01 capability profiles | Profile and unsupported-command tests |
...
| I-01 | Vendor a versioned physical contract with pinned SHA-256 | Contract test and manifest |
